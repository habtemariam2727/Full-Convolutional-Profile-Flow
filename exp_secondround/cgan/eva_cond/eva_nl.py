...
gen_datapath = 'exp_secondround/cgan/cond_gen_nl/generated_samples.csv'
origial_data_path = os.path.join(_parent_path, 'data/nl_data_cleaned_annual_test.csv')
...
# Plot the samples
save_path = 'exp_secondround/cgan/eva_cond/nl_gen_samples.png'
save_path_original = 'exp_secondround/cgan/eva_cond/nl_original_samples.png'  
